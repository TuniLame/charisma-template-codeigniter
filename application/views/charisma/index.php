...
<div class="row-fluid">
	<div class="box span12">
		...
		<div class="box-content">
			<h1>
				Charisma <small>free, premium quality, responsive, multiple skin
					admin template.</small>
			</h1>
			<p>Its a live demo of the template. I have created Charisma to ease
				the repeat work I have to do on my projects. Now I re-use Charisma
			...
			<p class="center">
				<a href="http://usman.it/free-responsive-admin-template"
					...
					class="btn btn-large"><i class="icon-download-alt"></i> Download
					Page</a>
			</p>
		...
		<div class="box-content">
			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane active" id="info">
					...
					<p>Its a fully featured, responsive template for your admin panel.
